...
static const AVOption asamplemerge_options[] = {
...
AVFILTER_DEFINE_CLASS(asamplemerge);
...
static int activate(AVFilterContext *ctx) {
  ...
  printf("Thomas:: called the asamplemerge filter\n");
...
static const AVFilterPad asamplemerge_inputs[] = {
    {
        .name = "default",
...
static const AVFilterPad asamplemerge_outputs[] = {
    {
        .name = "default",
        .type = AVMEDIA_TYPE_AUDIO,
    },
...
const AVFilter ff_af_asamplemerge = {
    .name = "asamplemerge",
    .description = NULL_IF_CONFIG_SMALL("Create output frames with a fixed size of 1764 samples"),
    .priv_size = sizeof(AmergeCtx),
    .priv_class = &asamplemerge_class,
    FILTER_INPUTS(asamplemerge_inputs),
    FILTER_OUTPUTS(asamplemerge_outputs),
    .activate = activate,
};
